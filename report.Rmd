...
If this trend continues, by 2018 the average level of `r tolower(filtered[1,"Indicator.Name"])` will be `r round(newvalue,1)` per 100,000 - an estimated `r format(round(newvalue*3224,0),scientific=FALSE)` annually. This represents a `r percent((newvalue-oldvalue)/oldvalue)` change since `r input$yearInput`.
